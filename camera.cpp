...
{ // make default camera 
    ...
    if( DEBUG )
        std::cout << "Calling setDefaultCamera\n";
...
{ // load modelview matrix with existing camera values 
    ...
    if( DEBUG )
        std::cout << "Calling setModelViewMatrix\n";

    //std::cout<<eye.x<<" "<<eye.y<<" "<<eye.z<<std::endl;
    //std::cout<<n.x<<" "<<n.y<<" "<<n.z<<std::endl;
    //std::cout<<u.x<<" "<<u.y<<" "<<u.z<<std::endl;
    //std::cout<<v.x<<" "<<v.y<<" "<<v.z<<std::endl;
    //eye = Point3(11.31,9.05,6.77);
    //n = Vector3(0.734, 0.538, 0.414);
    //u = Vector3(0.601, -0.232, -0.765);
    //v = Vector3(-0.315, 0.810, -0.494);
    float m[16]; 
...
{ // load projection matrix and camera values 
    ...
    if( DEBUG )
        std::cout << "Calling setShape, vAngle: " << vAngle << ", asp: " << asp << ", nr: " << nr << ", fr: " << fr << "\n";
